...
Pioneering research nearly a century later by McGeer \cite{McGeer:1990uk} produced \emph{passive} bipeds capable of dynamically stable gait without any control effort. This work led to a new class of passivity-based electromechanical designs for bipedal robots (Section~\ref{sub:related_passive_designs}). Similarly, pioneering research in the area of actively controlled bipedal locomotion by Vukobratovic \cite{vukobratovic1969} gave rise to the most common electromechanical design approach (Section~\ref{sub:related_active_designs}). The first \emph{active} bipedal robot, WL-5 was developed in the 1972 by Kato et al. at Waseda University \cite{kato1972hydraulically}. Since then, the number of bipedal robots being developed for commercial and research applications has been growing rapidly.
