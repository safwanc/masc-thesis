...
The actuation strategy used for most powered walkers have relied on complete (fully active) control of every joint. Electric motors are most commonly selected for bipedal robot designs using this strategy. However, some designs like the force-controllable SARCOS humanoid CB use hydraulic actuators \cite{SangHoHyon:2007jy}. 
