...
The actuation strategy used for most powered walkers have relied on complete (active) control of every joint. Electric motors are most commonly used for this approach. However, some designs like the force-controllable SARCOS humanoid CB use hydraulic actuators \cite{SangHoHyon:2007jy}. 
