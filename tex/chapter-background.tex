...
\label{sub:related_passivity_based_designs}
...
\label{sub:related_actively_powered_designs}
...
\label{sub:related_force_impedance_control}
\Incomplete
% subsection force_impedance_control (end) ====================================


\subsection{Machine Learning} % (fold) ========================================
\label{sub:machine_learning_strategies}
\Incomplete
