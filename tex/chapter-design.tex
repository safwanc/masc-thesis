...
This chapter presents the electromechanical design of a bipedal robot for experimental validation. The goal was to design a lower body humanoid robot which would be easy to model, manufacture and be capable of performing a wide variety of gait cycles. A reduced set of DOF is selected for each leg for walking, balancing and to achieve full mobility in the ankle (breakdown provided in Table~\ref{tab:doftable}). The bipedal robot is also designed to be fully actuated with overpowered electric motors to physically support the wide range of gait styles for experimentation. 
