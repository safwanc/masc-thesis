...
\begin{figure}[!h]
	\begin{center}
	\subfigure{\includegraphics[scale=0.3]{fig/ch4/understeppingtime.eps}}
	\subfigure{\includegraphics[scale=0.3]{fig/ch4/understeppingphase.eps}}
	\end{center}
...
\begin{figure}[!h]
	\begin{center}
	\subfigure{\includegraphics[scale=0.3]{fig/ch4/oversteppingtime.eps}}
	\subfigure{\includegraphics[scale=0.3]{fig/ch4/oversteppingphase.eps}}
	\end{center}
