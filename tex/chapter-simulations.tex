...
\begin{figure}[!h]
	\centering
    \includegraphics[scale=0.6]{fig/simulations/comtraj.eps}
...
\begin{figure}[!h]
	\centering
    \includegraphics[scale=0.6]{fig/simulations/fpetrack.eps}
