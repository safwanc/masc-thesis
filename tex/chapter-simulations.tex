...
The initial spring-damper contact model discussed in Section~\ref{sub:initial_contact_modeling} was modified for the full dynamic simulations. Equation (\ref{eq:contactf}) was modified as follows: 
