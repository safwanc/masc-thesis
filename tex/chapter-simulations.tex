...
\begin{figure}[!b]
    ...
    \includegraphics[scale=0.8]{fig/fpe/comtraj3d.eps} 
  	\caption{Trajectory for $x_{COM}$ to ensure forward progress and off-sagittal stability.}
	\label{fig:comtraj3d}
\end{figure}
...
\begin{figure}[!b]
    ...
    \includegraphics[scale=0.8]{fig/fpe/swingfoottraj.eps} 
  	\caption{Trajectory for $x_{SWING}$ along the selected (sagittal) $xz$-plane.}
