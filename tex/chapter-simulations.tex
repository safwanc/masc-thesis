...
\subsection{Overstepping vs. Understepping} % (fold)
...
\begin{figure}[!h]
	\begin{center}
	\subfigure{\includegraphics[scale=0.3]{fig/simulations/understeppingtime.eps}}
	\subfigure{\includegraphics[scale=0.3]{fig/simulations/understeppingphase.eps}}
	\end{center}
...
\begin{figure}[!h]
	\begin{center}
	\subfigure{\includegraphics[scale=0.3]{fig/simulations/oversteppingtime.eps}}
	\subfigure{\includegraphics[scale=0.3]{fig/simulations/oversteppingphase.eps}}
	\end{center}
